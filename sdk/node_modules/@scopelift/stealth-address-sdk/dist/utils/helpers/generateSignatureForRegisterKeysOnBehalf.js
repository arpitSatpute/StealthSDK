 ...
 * });
 */
async function generateSignatureForRegisterKeysOnBehalf({ walletClient, account, ERC6538Address, chainId, schemeId, stealthMetaAddressToRegister }) {
    try {
        ...
        throw new GenerateSignatureForRegisterKeysError('Failed to generate signature for registerKeysOnBehalf', error);
    }
}
