 ...
 */
function generateStealthMetaAddressFromKeys({ spendingPublicKey, viewingPublicKey }) {
    ...
    const stealthMetaAddress = `0x${spendingPublicKey.slice(2)}${viewingPublicKey.slice(2)}`;
