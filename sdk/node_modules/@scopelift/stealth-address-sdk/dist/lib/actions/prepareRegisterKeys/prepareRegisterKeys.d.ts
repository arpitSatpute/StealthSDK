import type { PrepareRegisterKeysParams, PrepareRegisterKeysReturnType } from './types';
/**
 ...
 */
declare function prepareRegisterKeys({ ERC6538Address, schemeId, stealthMetaAddress, account, clientParams }: PrepareRegisterKeysParams): Promise<PrepareRegisterKeysReturnType>;
