 ...
 */
async function getStealthMetaAddress({ clientParams, ERC6538Address, registrant, schemeId }) {
    ...
    try {
        ...
        throw new GetStealthMetaAddressError(`Error getting stealth meta address: ${error}`);
    }
}
